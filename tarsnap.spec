...
%build
%configure --with-bash-completion-dir=%{_sysconfdir}/bash-completion.d
%{__make} %{?_smp_mflags}
...
%{_sysconfdir}/bash-completion.d/tarsnap*
%{_bindir}/tarsnap*
%{_mandir}/man*/tarsnap*

%changelog
* Sun Sep 03 2017 Jerzy Drozdz <rpmbuilder@jdsieci.pl> - 1.0.39-1
- update to 1.0.39

* Sat Jul 02 2016 Jerzy Drozdz <rpmbuilder@jdsieci.pl> - 1.0.37-1
- update to 1.0.37

* Wed Oct 21 2015 Jerzy Drozdz <rpmbuilder@jdsieci.pl> - 1.0.36.1-1
- update to 1.0.36.1
- enabled bash-completion scripts

* Wed May 27 2015 Jerzy Drozdz <rpmbuilder@jdsieci.pl> - 1.0.35-1
- rebuild
